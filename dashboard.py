...
with tab_grade:
    ...
    **❓ 왜 '프리미엄'이나 '선물용'의 객단가가 더 낮거나 비등하게 보이나요?**
    ...
    st.info("""
    **💡 목적별 마케팅 인사이트**
    - **자기소비용 (Family/Self)**: 재구매 비중이 월등히 높습니다. **'정기 구독'**이나 **'대용량 추가 할인'** 쿠폰을 통해 구매 주기를 단축시키는 전략이 유효합니다.
    - **선물용 (Gift)**: 재구매보다는 신규 유입이나 시즌성 구매가 강합니다. **'보내는 분의 품격'**을 강조하는 마케팅과 **'메시지 카드/보자기 포장'** 등 서비스 요소를 강화하여 객단가를 방어해야 합니다.
    """)
